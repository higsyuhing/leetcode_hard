...
/*
it's not that interesting because it is a straightforward repeating work of
leetcode 79. 

note that it recover grid instead of mine, using a stack, which is a much better way. 
*/
